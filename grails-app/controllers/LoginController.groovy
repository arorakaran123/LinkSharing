 ...
 */
    ...
    def register(RegisterCO registerCO) {
        ...
        if (registerCO.hasErrors()) {
            ...
            flash.registrationError = 'Please enter correct entries'
            render(view: '/login/auth')
            return;
        }
        User user = new User(isAdmin: false, isActive: true)
        bindData(user, registerCO)
        loginService.register(user, registerCO)
        flash.success = 'You are registered successfully. Please login to continue'
